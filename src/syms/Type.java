...
public abstract class Type 
{
    ...
    public ExpNode coerceToType( ExpNode exp ) 
        ...
        errors.debugMessage( "Coercing " + exp + ":" + exp.getType() + " to " + this );
        errors.incDebug();
        ExpNode newExp = exp;
        ...
        if( !this.equals( fromType ) && fromType != ERROR_TYPE ) {
            ...
            try {
                ...
                errors.debugMessage("Failed to coerce " + newExp + " to " + this);
                errors.decDebug();
                throw e;
            }
        }
        ...
        protected ExpNode coerce( ExpNode exp ) throws IncompatibleTypes {
            ...
            if( fromType instanceof SubrangeType ) {
                ...
                if( this.equals( baseType ) ) {
                    errors.debugMessage("Widened " + fromType + " to " + baseType);
    ...
    public static class SubrangeType extends ScalarType {
        ...
        protected ExpNode coerce( ExpNode exp ) throws IncompatibleTypes {
             ...
             */
            errors.debugMessage("Narrowed " + exp.getType() + " to " + this);
                ...
                if( this.getTypes().size() == args.getArgs().size() ) {
                    ...
                    for( Type t : this.getTypes() ) {
                        ...
                        try {
                            ...
                            errors.debugMessage("Can't coerce " + subExp + " to " + t);
                            errors.decDebug();
                            throw e;
                        }
                    }
        ...
        protected ExpNode coerce( ExpNode exp ) throws IncompatibleTypes {
            ...
            for( Type toType : this.getTypes() ) {
                try {
                    ...
                    errors.debugMessage("Coerced " + exp + " to " + toType);
                    return newExp;
                } catch( IncompatibleTypes ex ) {
                    errors.debugMessage("Can't coerce " + exp + " to " + toType);
    ...
    public static ExpNode optDereferenceExp( ExpNode exp ) {
        ...
        if( fromType instanceof ReferenceType ) {
            ...
            errors.debugMessage( "Coerce dereferencing " + fromType );
            return 
